...
export function MonthViewWeb({
  ...
  return (
    <div className={isDesktop ? "px-0 pt-7 pb-8" : "px-4 pt-4 pb-32"}>
      {/* 애플 캘린더 스타일 헤더 — 좌상단 알약 ← 2026년 + 우상단 알약 액션 */}
      <div
        className="flex items-center justify-between"
        style={{ paddingLeft: 0, paddingRight: 0, marginBottom: isDesktop ? 20 : 16 }}
      >
        {/* 좌측: 알약형 ← 연도 버튼 */}
        {onBack ? (
          <button
      ...
      <div
        style={{
          ...
          letterSpacing: isDesktop ? "-0.4px" : "-1.4px",
          lineHeight: isDesktop ? 1.08 : 1,
          color: "var(--text-primary)",
      ...
      {sheet && (
        ...
        >
          ...
          <div
            className={`relative w-full max-w-[375px] mx-auto ${isDesktop ? "rounded-3xl" : "rounded-t-3xl"} p-5 pb-8 sheet-slide-up`}
